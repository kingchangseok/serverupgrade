// $Id: HttpClient.java,v 1.4 2005/06/07 05:58:27 tomy Exp $
/*
 ...
 *
 */
public class HttpClient extends ChatSocket {
	 ...
	 * @throws IOException
	 */
	public HttpClient(SocketAddress addr) throws IOException {
		super(addr);
        terminator = "\r\n\r\n".getBytes();
	}
     ...
     */
    protected void foundTerminator() {
