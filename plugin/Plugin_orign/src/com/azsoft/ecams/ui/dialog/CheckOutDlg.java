...
public class CheckOutDlg extends WizardDialog implements IPageChangedListener
{
	/**
	 * @wbp.parser.constructor
	 */
	private CheckOutSelectResourcePage page1;
	private CheckOutRequestPage page2;
	...
	public CheckOutDlg(Shell parentShell, IWizard newWizard) {
	...
	protected void nextPressed() {
		// TODO Auto-generated method stub
		page1 = (CheckOutSelectResourcePage)getCurrentPage();
		...
		page2 = (CheckOutRequestPage)page1.getNextPage();
