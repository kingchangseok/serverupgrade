...
public class ConfirmMessage2Dlg extends Dialog {
	...
	public ConfirmMessage2Dlg(Shell parentShell) {
		super(parentShell);
	 ...
	 */
	public ConfirmMessage2Dlg(Shell parentShell,String title,String message) {
		super(parentShell);
...
//		});
		cancelButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseDown(MouseEvent e) {
//				CheckInRealDlg.setChkBefSelection(false);
			//	setReturnCode(CANCEL);
//				parentShell.dispose();
//				parentShell.close();
//				parentShell.addDisposeListener(listener);
