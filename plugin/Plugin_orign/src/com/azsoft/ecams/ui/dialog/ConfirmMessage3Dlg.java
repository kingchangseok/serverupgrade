...
public class ConfirmMessage3Dlg extends Dialog {
	...
	public ConfirmMessage3Dlg(Shell parentShell) {
		super(parentShell);
	 ...
	 */
	public ConfirmMessage3Dlg(Shell parentShell,String title,String message) {
		super(parentShell);
