...
import com.azsoft.ecams.ui.wizard.page.DeleteRequestPage;
import com.azsoft.ecams.ui.wizard.page.DeleteResourcePage;

public class DeleteDlg extends WizardDialog implements IPageChangedListener
{
	/**
	 * @wbp.parser.constructor
	 */
	private DeleteResourcePage page1;
	private DeleteRequestPage page2;
	
	Object[] selectedResource;
	


	public DeleteDlg(Shell parentShell, IWizard newWizard) {
	...
	protected void nextPressed() {
		// TODO Auto-generated method stub
		page1 = (DeleteResourcePage)getCurrentPage();
		...
		page2 = (DeleteRequestPage)page1.getNextPage();
